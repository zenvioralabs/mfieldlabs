...
export default function Hero() {
  ...
  return (
    <section id="top" className="relative flex min-h-[calc(100vh-80px)] flex-col justify-center overflow-hidden bg-white px-5 pb-16 pt-20 sm:px-8 md:px-12 lg:px-16 lg:pb-20 lg:pt-24">
      <div className="mx-auto grid max-w-[1240px] items-center gap-8 lg:grid-cols-[0.95fr_1.05fr] lg:gap-4">
        ...
        >
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <a href="#contact" className="outline-pill group">
